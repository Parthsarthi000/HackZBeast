      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="mb-8 text-center">
            <h1 className="text-2xl mb-2 text-gray-900">Welcome back!</h1>
          ...
          <div className="mb-6 rounded-xl overflow-hidden">
            <img
              src="https://images.unsplash.com/photo-1560523159-fbe43c0b465f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYW5ndWFnZSUyMGxlYXJuaW5nJTIwc3R1ZHlpbmd8ZW58MXx8fHwxNzcyMjU0MDIyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          Learn languages naturally, from what you read.
        </p>
      </div>
    </div>
  );
